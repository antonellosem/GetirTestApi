...
namespace PgadCommunication.Contracts.Requests
{
    ...
    public class MessaggioPersonaGiuridica2 : MessaggioPGAD
    {
        public MessaggioPersonaGiuridica2(int titolareSistema, string contoGioco, long idTransazione, sbyte tipoContoPersonaGiuridica) : base(titolareSistema, idTransazione)
        {
            
            _personaGiuridica = new AperturaContoPersonaGiuridica2RequestElements
            {
            ...
            _personaGiuridica.tipoContoPersonaGiuridica = tipoContoPersonaGiuridica;
        }
        ...
        private AperturaContoPersonaGiuridica2RequestElements _personaGiuridica;
        public AperturaContoPersonaGiuridica2RequestElements PersonaGiuridica
        {
            get
            {
