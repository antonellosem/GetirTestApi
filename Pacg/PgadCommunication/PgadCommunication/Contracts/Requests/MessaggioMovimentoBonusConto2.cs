...
namespace PgadCommunication.Contracts.Requests
{
    ...
    public class MessaggioMovimentoBonusConto2 : MessaggioPGAD
    {
        private readonly MovimentazioneBonusConto2RequestElements _movimentoBonus;
        public MovimentazioneBonusConto2RequestElements MovimentoBonus
        {
            get
            {
        ...
        public MessaggioMovimentoBonusConto2(int titolareSistema, string contoGioco,long idTransazione)
            : base(titolareSistema, idTransazione)
        {
            _movimentoBonus = new MovimentazioneBonusConto2RequestElements
            {
