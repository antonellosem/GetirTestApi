...
namespace PgadCommunication.Contracts.Requests
{
    ...
    public class MessaggioPersonaFisica2 : MessaggioPGAD
    {
        private readonly AperturaContoPersonaFisica2RequestElements _personaFisica;
        public AperturaContoPersonaFisica2RequestElements PersonaFisica
        {
            get
            {
        ...
        public MessaggioPersonaFisica2(int titolareSistema, string contoGioco, long idTransazione)
            : base(titolareSistema, idTransazione)
        {
            _personaFisica = new AperturaContoPersonaFisica2RequestElements
            {
        ...
        public void setAnagrafica(string codiceFiscale, string cognome, string nome, char sesso, string mail, string nickName)
        {
            ...
            {
                codiceFiscale = codiceFiscale, cognome = cognome, nome = nome
            };
            switch (sesso)
            {
                case 'M':
