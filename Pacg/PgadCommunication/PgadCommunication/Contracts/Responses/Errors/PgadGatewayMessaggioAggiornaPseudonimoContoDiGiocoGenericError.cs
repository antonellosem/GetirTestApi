...
namespace PgadCommunication.Contracts.Responses.Errors
{
    ...
    public class PgadGatewayMessaggioAggiornaPseudonimoContoDiGiocoGenericError : PgadGatewayMessaggioAggiornaPseudonimoContoDiGiocoResponse
    {
        public PgadGatewayMessaggioAggiornaPseudonimoContoDiGiocoGenericError(long idTransazione, string descrizioneErrore) :
